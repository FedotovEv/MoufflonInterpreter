...
#endif
{
    ...
    THRM_STRING_ENCODING_ERROR,             // Ошибка при работе с кодироваками строк.
    ...
    THRM_GLOBAL_IN_METHOD_ONLY,                 // Директива global допускается только внутри тела метода.
    ...
    THRM_UTF8_EXTRACT_ERROR,        // "Ошибка извлечения кода из UTF-8-строки в положении "
    // Конец определения списка кодов ошибок.
    THRM_MAX_VALUE = THRM_UTF8_EXTRACT_ERROR    // Абсолютно максимальное значение данного перечисления.
};
