...
namespace runtime
{
    ...
    public:
        ...
        // значения индивидуально. Эти настройки определяют режим сравнения этой стороки с какой-либо другой, если при
        // такой операции данная строка является ведущей (первым операндом сравнения).
        // -------------------------------
