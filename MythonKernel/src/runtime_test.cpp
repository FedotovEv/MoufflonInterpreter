...
namespace runtime
{
    namespace
    {
        ...
        void TestMethodInvocation()
        {
            ...
            base_closure.clear();
            res = child_inst.Call
                ("test"s, {ObjectHolder::Own(String{"value1"s}), ObjectHolder::Own(String{"value2"s})}, context);
        ...
        void TestIsTrue()
        {
            ...
            ASSERT(!IsTrue(ObjectHolder::None()));  // None приводится к "ЛОЖЬ".

            // Числа, равные 0, также рассматриваются как "ЛОЖЬ". Остальные приводятся к "ИСТИНЕ".
            {
            ...
            // Пустые строки - "ЛОЖЬ". Непустые - "ИСТИНА".
            {
        ...
        void TestComparison()
        {
            ...
            // Числа.
            {
                ...
                // Числа не могут сравниваться со значениями других типов.
            ...
            // Логические значения.
            {
                ...
                // Логические значения также несравнимы со значениями иных типов.
            ...
            // Экземпляры классов.
            {
                ...
                // Создаём класс, поддерживающий операции сравнения над своими экземплярами. Сравнительные действия
                // в этом случае будут фиктивными, возвращающими заранее известный результат.
    ...
    {
        cout << "\nТесты работы универсального контейнера - хранилища значений программы.\nПроверка создания и обработки значений различных типов" << endl;
    ...
    {
        cout << "\nТесты работы универсального контейнера - различные его типы и операции над ним" << endl;
