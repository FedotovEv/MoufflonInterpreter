...
то не следует плодить сущности без всякой к тому необходимости.
  ...
  Вполне возможно, что будет добавлена простейшая поддержка модульности на уровне
исходного текста по типу директивы C-препроцессора #include. Необходимости каких-либо
иных крупных усовершенствований языка мы в данный момент не видим. В принципе, можно
утверждать, что в настоящей версии языка программирование на нем уже является вполне
комфортным и его можно считать достаточно зрелым и отвечающим своему основному назначению.
