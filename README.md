...
определённый так:
        ...
        namespace runtime
        {
            ...
            using LinkageReturn = variant<int, double, string>;
...
величину,   либо число с плавающей точкой, либо   строку.   Возвращенный   таким
способом результат будет считаться  в   программе   текущим   значением   самого
этого   поля.   При выполнении  записи  возвращаемое значение игнорируется.
